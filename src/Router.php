...
class Router {
	 ...
	 */
	public function map($method, $route, $target, $namespace, $name = null) {

		$this->routes[] = array($method, $route, $target, $namespace, $name);
	...
	public function match($requestUrl = null, $requestMethod = null) {
		...
		foreach($this->routes as $handler) {
			list($method, $_route, $target, $namespace, $name) = $handler;
